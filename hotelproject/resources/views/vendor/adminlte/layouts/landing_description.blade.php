                    ...
                    <div class="sub-section">
                        <div>
                            <div class="sub-section-left">
                                <h2 style="color: red;">Bữa sáng</h2>
                            </div>
                            <div class="sub-section-right">
                                <p style="font-size:18px; padding: 20px;">
                                    Bữa sáng được phục vụ tận phòng với đa dạng các món ăn và đặc sản đến từ nhiều nơi trên thế giới như Hàn Quốc, Ấn Độ, Italy, Nhật Bản, Chile, ...với chất lượng cao và được vận chuyển an toàn
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="sub-section-left">
                                <h2 style="color: red;">Di chuyển</h2>
                            </div>
                            <div class="sub-section-right">
                                <p style="font-size:18px; padding: 20px;">
                                    Dịch vụ cung cấp những tiện lợi khi đi lại bằng xe của công ty với các loại xe minivan và xe vận chuyển an toàn. Ngoài ra, công ty còn cung cấp dịch vụ cho thuê các dòng xe sang trạng như porsche, ferarri hay lamboghini với kiểu dáng sang trọng khi ở khách sạn
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="sub-section-left">
                                <h2 style="color: red;">Liên lạc</h2>
                            </div>
                            <div class="sub-section-right">
                                <p style="font-size:18px; padding: 20px;">
                                    Tổng đài với số 100000 luôn thường trực cho những nhu cầu và góp ý của khách hàng 24/7 trong tuần với đội ngũ nhân viên tận tình và chu đáo. Đường dây này là bảo mật và khách hàng có thể có những đóng góp để công ty có thể phát triển và đổi mới.
                                </p>
                            </div>
                        </div>
